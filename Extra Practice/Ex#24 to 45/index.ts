...
if (age_q28 < 2) console.log("person is a baby");
else if (age_q28 >= 2 && age_q28 < 4) console.log("person is toddler");
else if (age_q28 >= 4 && age_q28 < 13) console.log("person is a kid");
else if (age_q28 >= 13 && age_q28 < 20) console.log("person is a teenager");
else if (age_q28 >= 20 && age_q28 < 65) console.log("person is an adult");
...
if (favFruits_q29.includes("apple")) console.log("your array has apples!");
