...
while (flag == false) {
    ...
    if (answer.operations == "Addition") {
        console.log(chalk.greenBright.bgBlueBright.bold("\t\t\tAnswer:" + addition(answer.number1, answer.number2).toFixed(2)));
    }
    else if (answer.operations == "Subtraction") {
        console.log(chalk.greenBright.bgBlueBright.bold('\t\t"Answer:' + subtraction(answer.number1, answer.number2).toFixed(2)));
    }
    else if (answer.operations == "Multiplication") {
        console.log(chalk.greenBright.bgBlueBright.bold('\t\t"Answer:' +
            multiplication(answer.number1, answer.number2).toFixed(2)));
    }
    else if (answer.operations == "Division") {
        console.log(chalk.greenBright.bgBlueBright.bold('\t\t"Answer:' + division(answer.number1, answer.number2).toFixed(2)));
    }
