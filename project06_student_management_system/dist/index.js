...
async function main() {
    while (true) {
        ...
        if (answer.task == "addStudent") {
            ...
            let newStudent = new Student(student.first_name, student.last_name, student.age, student.phone);
        ...
        ////////////////////
            ...
            const studentFound = studentsArray.find((student) => student.studentID === id.rollNo);
        ...
        /////////////////////////
            ...
            if (studentFound) {
                if (studentFound.coursesEnrolled.includes(id.course))
                    console.log(`Student has already enrolled to following courses:\n${studentFound.coursesEnrolled}`);
