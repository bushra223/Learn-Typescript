...
const favPeople_q17: string[] = ["Attique", "Mamoona", "Zunash"];
console.log("Oops! I can only invite 2 people now.");
// • Remove guests from your list one at a time until only two names remain in your list. Each time you pop a name from your list, print a message to that person letting them know you’re sorry you can’t invite them to dinner.
favPeople_q17.forEach((element) => {
	if (favPeople_q17.length > 2)
		console.log(
			`I am sorry ${favPeople_q17.pop()}! I can’t invite you to dinner.`
		);
});
...
let arr_length_fixed = favPeople_q17.length;
