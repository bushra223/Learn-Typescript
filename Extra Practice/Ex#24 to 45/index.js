...
let current_users = ["BushrA", "BILAL", "anas", "attique"];
...
let pizzas = ["Fajita", "Texan BBQ", "Chicken Supreme"];
...
console.log("I really like pizza. My favourite flavours in pizza are chicken supreme, and texan BBQ.I really love pizza. ");
...
console.log("All of above mentioned animals can be kept as pet, are farm animals, have four legs and are mammals. These animals would make a great pet");
console.log("Exercise # 36");
// T-Shirt: Write a function called make_shirt() that accepts a size and the text of a message that should be printed on the shirt. The function should print a sentence summarizing the size of the shirt and the message printed on it. Call the function.
function make_shirt(size, msg) {
    console.log(`Shirt size is ${size} and the text to be printed on shirt is "${msg}".`);
}
...
function make_shirt3(msg, size) {
    if (size && msg)
        console.log(`Size of shirt is ${size} and the text to be printed on shirt is "${msg}!"`);
    else if (size && !msg) {
        console.log(`Size of shirt is ${size} and the text to be printed on shirt is "I Love Typescript!"`);
    }
    else if (!size && !msg)
        console.log(`Size of shirt is large and the text to be printed on shirt is "I Love Typescript!"`);
}
make_shirt3();
...
function describe_city(cityName, country_name) {
    if (!country_name)
        console.log(`${cityName} is in Pakistan`);
    else
        console.log(`${cityName} is in ${country_name}`);
}
...
let album1, album2, album3, album4;
...
let magician_names = ["Archimedes", "Alistair", "Azura"];
...
function prepare_sandwich(...sandwich_items) {
...
let myCar = car_info("Honda", "Civic", {
    colour: "blue",
    availability: true,
    mileage: 3245,
});
