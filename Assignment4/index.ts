...
let number1 = 20,
	number2 = 3; // Use the modulus operator (%) to find the remainder.
...
if (num1 % 2 == 0) console.log("number1 is even.");
else console.log("number1 is odd.");

if (num2 % 2 != 0) console.log("number2 is odd");
else console.log("number2 is odd.");
...
age = 20;
console.log(`Age=${age}`);
if (age >= 18) console.log("Persson is eligible to cast vote.");
else console.log("Person is not eligible to cast vote");
...
let score: number = 0; // Use conditionals to assign and print grades A, B, C, D, or F.
//all inputs are in string, Number casts string to number

score = Number(prompt(`Please enter marks of student out of 100:`));
if (score <= 100 && score >= 80) console.log("Grade A");
else if (score < 80 && score >= 60) console.log("Grade B");
else if (score < 60 && score >= 50) console.log("Grade C");
else if (score < 50 && score >= 40) console.log("Grade D");
else console.log("Grade F");

console.log("12. Max of Three");
//Instructions: Find the maximum of three numbers.

let x, y, z, Max: number; // Determine the largest among these.
...
let fahrenheit: number = Number(prompt("Enter temperature in Frahrenheit:")); // Convert this to Celsius and print the result.
...
if (number1 < 0) console.log(`${number1} is negative`);
	...
	if (number1 > 1) console.log(`${number1} is positive`);
	else console.log(`${number1} is zero`);
}
...
number1 = Number(
	prompt("Which times table do you want to see? choose from 1 to 10:")
);
for (let i = 1; i <= 10; ++i) {
