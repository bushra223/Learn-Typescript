...
const favPeople_q15 = ["Attique", "Mamoona", "Zunash"];
console.log(`${favPeople_q15[0]} can't attend the dinner because he is out of country`);
let index_q15 = favPeople_q15.indexOf("Attique");
